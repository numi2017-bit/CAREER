...
def create_season2_negative_top5_bar_v2():
    """시즌 2 실제 부정 키워드 TOP 5 막대 그래프 생성 V2 (인성 키워드 추가)"""
    ...
    # 핵심 부정 키워드 목록 업데이트 (워드클라우드와 싱크 맞춤)
    negative_keywords_map = {
        ...
        # 인성 관련 키워드 추가
        '인성': '출연진 태도/인성', '싸가지': '출연진 태도/인성', '거만': '출연진 태도/인성', 
        '태도': '출연진 태도/인성', '무례': '출연진 태도/인성', '예의': '출연진 태도/인성'
    }
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_path, 'season2_negative_top5_bar_v2.png'), dpi=150, bbox_inches='tight')
    plt.close()
    print("✓ Saved: season2_negative_top5_bar_v2.png")

if __name__ == "__main__":
    create_season2_negative_top5_bar_v2()
